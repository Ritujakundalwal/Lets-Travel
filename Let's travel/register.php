...
<body class="register-body">
    ...
    <section class="registration">
        <div class="register-form">
            ...
            <h4>Upload ID :</h4><input type="file" name="file" placeholder="Aadhaar Number" id="myfile" required>
            ...
            <input type="checkbox" name="td" id=""> Jallianwala Bagh &nbsp; &nbsp; &nbsp;
            <input type="checkbox" name="td" id=""> Munnar &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
        
            <input type="checkbox" name="td" id=""> jaisalmer &nbsp; &nbsp; &nbsp;
            <input type="checkbox" name="td" id=""> Agra &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <input type="checkbox" name="td" id=""> Sundarban national Park &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; 
            <input type="checkbox" name="td" id=""> Statue of Unity &nbsp; &nbsp; &nbsp;
            <input type="checkbox" name="td" id=""> Hampi &nbsp; &nbsp; &nbsp;
            <br> <br>
            <h4>Package</h4>
            ...
            <br> <br> 
            <input type="submit" value="Submit" class="submitbtn" name="button">
